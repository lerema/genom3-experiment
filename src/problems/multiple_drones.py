...
def demo_time_triggered_problem():
    ...
    survey.add_effect(StartTiming(), is_robot_available(r), False)
    survey.add_effect(EndTiming(), is_surveyed(), True)
    survey.add_effect(EndTiming(), is_robot_available(r), True)
...
def demo_sequential_problem():
    ...
    l_from = survey.parameter("From")
    r = survey.parameter("robot")
    survey.add_precondition(is_robot_available(r))
    ...
    survey.add_effect(is_robot_available(r), False)
    survey.add_effect(is_surveyed(), True)
    survey.add_effect(is_robot_available(r), True)
    ...
    l_to = move.parameter("l_to")
    r = move.parameter("robot")
    move.add_precondition(is_robot_available(r))
    ...
    move.add_effect(is_robot_available(r), False)
    move.add_effect(robot_at(r, l_to), True)
    move.add_effect(is_robot_available(r), True)
    ...
    r = inspect_plate.parameter("robot")
    l = inspect_plate.parameter("location")
    inspect_plate.add_precondition(is_robot_available(r))
